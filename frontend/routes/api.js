...
router.get('/search/:ticker', function(req, res, next) {
    ...
    console.log("\napi call from searh to the backend\n");
...
router.get('/chart/historical/:ticker', function(req, res, next) {
  ...
  .then(function(data) {
    ...
    console.log('https://api.tiingo.com/tiingo/daily/'+ticker+'/prices?startDate='+startDate+'&resampleFreq=daily&token=8bb5d357e4616c9938090e9e3de7acefc38d224b');
    // console.log(data);
